...
namespace PivotalGitHubSync\Glue;

/**
 * Simple pivotal api client.
 *
 * This class is based on the code from Joel Dare's PHP Pivotal Tracker Class.
 * https://github.com/codazoda/PHP-Pivotal-Tracker-Class
 */
class PivotalClient
{
    /**
     ...
     *
     * @var \PivotalGitHubSync\Glue\RestClient
     */
    private $client;
